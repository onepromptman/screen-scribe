...
node tools/render_docx.js tools/sample-analyst-report.json -o sample-report.docx
```

That renders the bundled fictional sample so you can see the template before
wiring anything up.
...
Two hard stops, both non-negotiable and both tested:
